...
//            common.HideDiv(this.P_map.line.children("div"));
            ...
            //                    //连线gif图片。
            //                    //指定图片的width(31)和height(35)，要不然连线可能会过长
            //                    row_gif = "<img src='Image/clue_row.gif' width=" + LianLianKan.config.BIGWIDTH.toString() + "px height=" + LianLianKan.config.BIGHEIGHT.toString() + "px/>";
            //                    col_gif = "<img src='Image/clue_col.gif' width=" + LianLianKan.config.BIGWIDTH.toString() + "px height=" + LianLianKan.config.BIGHEIGHT.toString() + "px/>";
            //                }
            //            div.each(function () {
            //                $(this).html();
            //            });
            ...
            //            //连线动画
            //            //未完！制作拐点的gif动画
            //            for (i = 0, len = LianLianKan.pathLine_arr.length; i < len; i++) {
            //                switch (LianLianKan.pathLine_arr[i][1]) {
            //                    case "x":
            //                        LianLianKan.pathLine_arr[i][0].html("<img src='Image/row.gif' width=31px height=35px/>");
            //                        LianLianKan.prePathLine.push(LianLianKan.pathLine_arr[i][0]);
            //                        continue;
            //                    case "y":
            //                        LianLianKan.pathLine_arr[i][0].html("<img src='Image/col.gif' width=31px height=35px/>");
            //                        LianLianKan.prePathLine.push(LianLianKan.pathLine_arr[i][0]);
            //                        continue;
            //                    default:
            //                        break;
            //                }
            //            }
            //            LianLianKan.pathLine_arr[0][0].html("<img src='Image/col.gif' width=31px height=35px/>");
            //            var of = LianLianKan.pathLine_arr[0][0].offset();
            //            div.eq(0).css({ "left": of.left + "px", "top": of.top + "px" });
            //            console.log(of.left);


            //                var m = LianLianKan.pathLine_arr;

            //                console.log(this.path_arr.length);
...
//            else {
//                //爆炸动画
//                div.eq(3).html("<img src='Image/boom.gif' onmousedown='operate.PreventDefault();'/>").css({ "left": offset_selected.left + "px", "top": offset_selected.top + "px" });
//                div.eq(4).html("<img src='Image/boom.gif' onmousedown='operate.PreventDefault();'/>").css({ "left": offset_current_block.left + "px", "top": offset_current_block.top + "px" });
//            }
            ...
            //                console.log("div.find('img').length + " + div.find("img").length);
