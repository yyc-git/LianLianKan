...
DOTA.Drag = function(dragElement, config){
	...
	this.config.handler = this.config.handler || this.drag;
	...
	DOTA.Event.addEvent(this.config.handler, "mousedown", this._startHandler);
	DOTA.Event.addEvent(this.config.handler, "click", this._clickHandler);
};
DOTA.Drag.prototype = {
	...
	dispose : function(){
		DOTA.Event.removeEvent(this.config.handler, "mousedown", this._startHandler);
		DOTA.Event.removeEvent(this.config.handler, "click", this._clickHandler);
